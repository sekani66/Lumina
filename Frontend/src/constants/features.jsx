export const FEATURES = [
    ...
    icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="m13 2-7 11h9l-2 9 11-13h-9l3-7z"/>
        </svg>
    ),
    ...
    body: 'Lumina tracks what you know, identifies gaps in your understanding and adjusts its teaching approach before you even realise you are stuck.',
    },
    {
    icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    body: 'Raise your hand mid-lesson. Ask a question without aborting the topic. Lumina answers and resumes exactly where it left off.',
    },
    {
    icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    body: 'Every learner follows a unique journey. Lumina accelerates where you are strong and slows down precisely where you need it most.',
    },
]
